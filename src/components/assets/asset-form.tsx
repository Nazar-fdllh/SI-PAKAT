...
export function AssetForm({ classifications, subClassifications, onSave, onCancel }: AssetFormProps) {
  ...
  const handleSanitizedInputChange = (
    ...
    form.setValue(field, sanitizedValue as any, { shouldValidate: true });
  };
  ...
  const DynamicFields = ({ classificationId }: { classificationId: number }) => {
    ...
    switch (classificationId) {
      case 1: // SDM & Pihak Ketiga
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-4 border rounded-md">
            <FormField key="personnel_name" control={form.control} name="personnel_name" render={({ field }) => ( <FormItem><FormLabel>Nama Personil</FormLabel><FormControl><Input placeholder="Nama Lengkap" {...field} onChange={e => handleSanitizedInputChange('personnel_name', e.target.value, /^[A-Za-z\s.,]*/)} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="employee_id_number" control={form.control} name="employee_id_number" render={({ field }) => ( <FormItem><FormLabel>NIP</FormLabel><FormControl><Input placeholder="Nomor Induk Pegawai" {...field} value={field.value || ''} onChange={(e) => form.setValue('employee_id_number', e.target.value.replace(/\D/g, ''), { shouldValidate: true })} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="function" control={form.control} name="function" render={({ field }) => ( <FormItem><FormLabel>Fungsi</FormLabel><FormControl><Input placeholder="cth. Manajemen Strategis" {...field} onChange={e => handleSanitizedInputChange('function', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="position" control={form.control} name="position" render={({ field }) => ( <FormItem><FormLabel>Jabatan</FormLabel><FormControl><Input placeholder="cth. Kepala Bidang" {...field} onChange={e => handleSanitizedInputChange('position', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
          </div>
        );
      case 2: // Sarana Pendukung
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-4 border rounded-md">
            <FormField key="condition" control={form.control} name="condition" render={({ field }) => ( <FormItem><FormLabel>Kondisi</FormLabel><FormControl><Input placeholder="cth. Baik, Perlu Perbaikan" {...field} onChange={e => handleSanitizedInputChange('condition', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="capacity" control={form.control} name="capacity" render={({ field }) => ( <FormItem><FormLabel>Kapasitas</FormLabel><FormControl><Input placeholder="cth. 5000 VA (untuk Genset)" {...field} onChange={e => handleSanitizedInputChange('capacity', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="last_maintenance_date" control={form.control} name="last_maintenance_date" render={({ field }) => ( <FormItem><FormLabel>Tgl. Perawatan Terakhir</FormLabel><FormControl><Input type="date" {...field} value={field.value || ''} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="next_maintenance_date" control={form.control} name="next_maintenance_date" render={({ field }) => ( <FormItem><FormLabel>Jadwal Perawatan Berikutnya</FormLabel><FormControl><Input type="date" {...field} value={field.value || ''} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="specification" control={form.control} name="specification" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Spesifikasi</FormLabel><FormControl><Textarea placeholder="Detail spesifikasi teknis" {...field} onChange={e => handleSanitizedInputChange('specification', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
          </div>
        );
      case 3: // Perangkat Keras
        return (
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-4 border rounded-md">
             <FormField key="brand" control={form.control} name="brand" render={({ field }) => ( <FormItem><FormLabel>Merek</FormLabel><FormControl><Input placeholder="cth. Dell, HP" {...field} onChange={e => handleSanitizedInputChange('brand', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
             <FormField key="model" control={form.control} name="model" render={({ field }) => ( <FormItem><FormLabel>Model</FormLabel><FormControl><Input placeholder="cth. Latitude 5420" {...field} onChange={e => handleSanitizedInputChange('model', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
             <FormField key="serial_number" control={form.control} name="serial_number" render={({ field }) => ( <FormItem><FormLabel>Nomor Seri</FormLabel><FormControl><Input placeholder="Nomor unik perangkat" {...field} onChange={e => handleSanitizedInputChange('serial_number', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
             <FormField key="condition" control={form.control} name="condition" render={({ field }) => ( <FormItem><FormLabel>Kondisi</FormLabel><FormControl><Input placeholder="cth. Baru, Bekas, Baik" {...field} onChange={e => handleSanitizedInputChange('condition', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
             <FormField key="specification" control={form.control} name="specification" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Spesifikasi</FormLabel><FormControl><Textarea placeholder="Detail spesifikasi teknis" {...field} onChange={e => handleSanitizedInputChange('specification', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
           </div>
        );
      case 4: // Perangkat Lunak
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-4 border rounded-md">
             <FormField key="application_name" control={form.control} name="application_name" render={({ field }) => ( <FormItem><FormLabel>Nama Aplikasi</FormLabel><FormControl><Input placeholder="cth. SI-PAKAT" {...field} onChange={e => handleSanitizedInputChange('application_name', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
             <FormField key="vendor" control={form.control} name="vendor" render={({ field }) => ( <FormItem><FormLabel>Vendor/Pembuat</FormLabel><FormControl><Input placeholder="cth. Diskominfo" {...field} onChange={e => handleSanitizedInputChange('vendor', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
             <FormField key="version" control={form.control} name="version" render={({ field }) => ( <FormItem><FormLabel>Versi</FormLabel><FormControl><Input placeholder="cth. 1.0.0" {...field} onChange={e => handleSanitizedInputChange('version', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
             <FormField key="status" control={form.control} name="status" render={({ field }) => ( <FormItem><FormLabel>Status Lisensi</FormLabel><FormControl><Input placeholder="cth. Berlisensi, Open Source" {...field} onChange={e => handleSanitizedInputChange('status', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
          </div>
        );
      case 5: // Data & Informasi
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-4 border rounded-md">
            <FormField key="storage_format" control={form.control} name="storage_format" render={({ field }) => ( <FormItem><FormLabel>Format Penyimpanan</FormLabel><FormControl><Input placeholder="cth. Digital, Cetak" {...field} onChange={e => handleSanitizedInputChange('storage_format', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="sensitivity_level" control={form.control} name="sensitivity_level" render={({ field }) => ( <FormItem><FormLabel>Tingkat Sensitivitas</FormLabel><FormControl><Input placeholder="cth. Rahasia, Internal, Publik" {...field} onChange={e => handleSanitizedInputChange('sensitivity_level', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="storage_location_detail" control={form.control} name="storage_location_detail" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Detail Lokasi Penyimpanan</FormLabel><FormControl><Input placeholder="cth. Folder X di Server Y" {...field} onChange={e => handleSanitizedInputChange('storage_location_detail', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="validity_period" control={form.control} name="validity_period" render={({ field }) => ( <FormItem><FormLabel>Masa Berlaku</FormLabel><FormControl><Input type="date" {...field} value={field.value || ''} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="last_backup_date" control={form.control} name="last_backup_date" render={({ field }) => ( <FormItem><FormLabel>Tanggal Backup Terakhir</FormLabel><FormControl><Input type="date" {...field} value={field.value || ''} /></FormControl><FormMessage /></FormItem> )} />
            <FormField key="retention_policy" control={form.control} name="retention_policy" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Kebijakan Retensi</FormLabel><FormControl><Textarea placeholder="Jelaskan kebijakan retensi data..." {...field} onChange={e => handleSanitizedInputChange('retention_policy', e.target.value, textAndNumberOnlyRegex)} /></FormControl><FormMessage /></FormItem> )} />
          </div>
        );
      default:
        return null;
