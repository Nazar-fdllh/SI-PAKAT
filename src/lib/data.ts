...
export const initialAssets: Asset[] = [
  ...
  { id: 'ast_002', assetCode: 'SW-OS-001', name: 'Lisensi Windows Server 2022', category: 'Aplikasi & Data', specifications: 'Datacenter Edition, 16-core license pack', location: 'N/A', owner: 'Divisi TI', status: 'Aktif', purchaseDate: '2022-01-10', expiryDate: '2025-01-09', classification: 'Tinggi' },
  ...
  { id: 'ast_004', assetCode: 'DT-FIN-001', name: 'Data Laporan Keuangan Tahunan', category: 'Aplikasi & Data', specifications: 'File-file laporan keuangan dalam format .xlsx dan .pdf', location: 'Server File Internal', owner: 'Divisi Keuangan', status: 'Aktif', purchaseDate: '2024-01-01', expiryDate: '2034-12-31', classification: 'Tinggi' },
  ...
  { id: 'ast_006', assetCode: 'SW-AV-001', name: 'Lisensi Antivirus Enterprise', category: 'Aplikasi & Data', specifications: 'Endpoint Security, 100 User License', location: 'N/A', owner: 'Divisi TI', status: 'Aktif', purchaseDate: '2023-06-01', expiryDate: '2024-05-31', classification: 'Sedang' },
  ...
  { id: 'ast_009', assetCode: 'DT-HR-002', name: 'Database Karyawan', category: 'Aplikasi & Data', specifications: 'Informasi personal dan rekam jejak karyawan', location: 'Server HR', owner: 'Divisi HR', status: 'Aktif', purchaseDate: '2020-02-01', expiryDate: '2030-01-31', classification: 'Tinggi' },
  ...
  { id: 'ast_012', assetCode: 'SW-DB-002', name: 'Lisensi Oracle Database', category: 'Aplikasi & Data', specifications: 'Enterprise Edition, per-processor license', location: 'N/A', owner: 'Divisi TI', status: 'Aktif', purchaseDate: '2021-05-15', expiryDate: '2026-05-14', classification: 'Belum Dinilai' },
